package com.example.advancedgyroscopedemo;
...
public class MainActivity extends Activity {
	...
	TextView gyro_disp[] = new TextView [3];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gyro_disp[0] = (TextView)findViewById(R.id.X_gyroID);
		gyro_disp[1] = (TextView)findViewById(R.id.Y_gyroID);
		gyro_disp[2] = (TextView)findViewById(R.id.Z_gyroID);
	...
	public void initListeners(){
	    ...
	    mSensorManager.registerListener(new SensorEventListener(){
			...
			public void onSensorChanged(SensorEvent event) {
				...
				String strX = OrientationDegree[0] + "";
				String strY = OrientationDegree[1] + "";
				String strZ = OrientationDegree[2] + "";		
				
				gyro_disp[0].setText(strX);
				gyro_disp[1].setText(strY);
				gyro_disp[2].setText(strZ);
