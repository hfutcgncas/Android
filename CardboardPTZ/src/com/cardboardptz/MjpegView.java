...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public final static int SIZE_down       = 12;
    public final static int SIZE_up         = 16;
    ...
    public class MjpegViewThread extends Thread {
        ...
        private Rect destRect(int bmw, int bmh) {
            ...
            //=================================================
            if (displayMode == MjpegView.SIZE_up){
                float bmasp = (float) bmw / (float) bmh;
                bmw = dispWidth;
                bmh = (int) (dispWidth / bmasp);
                if (bmh > dispHeight) {
            ...
            if (displayMode == MjpegView.SIZE_down){
            	float bmasp = (float) bmw / (float) bmh;
                bmw = dispWidth;
                bmh = (int) (dispWidth / bmasp);
                if (bmh > dispHeight) {
            ...
            while (mRun) {
                ...
                if(surfaceDone ) {   
                	try {
                		...
                		if(ret == -1)
                		{
                			System.out.println("bmpW----------------" );
                			((FullscreenActivity)saved_context).setImageError();
                			return;
                		}
