...
//	private SocketChannel socketChannel;
  //---------------------------------------------------------------------
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        RCamera_Enable = preferences.getBoolean("RCamera_Enable", RCamera_Enable);
      ...
      //  System.out.println("LCamera_Enable:"+LCamera_Enable);
        if(LCamera_Enable){
            mv = (MjpegView) findViewById(R.id.mv);   
            if(mv != null){
            	mv.setResolution(width, height);
            }
            System.out.println("Again L");
            new DoRead().execute(URL_left);      	
        }   

     //   System.out.println("RCamera_Enable:"+RCamera_Enable);
        if(RCamera_Enable){
     ...
     //   System.out.println("Gyroscope_Enable:"+Gyroscope_Enable);
        if(Gyroscope_Enable){
        	URL_GYRO  = new String(sb3);
        	port_GYRO = ip_port_Gyro;
        	mGyroscope = new Gyroscope(this);      
        	System.out.println("Again G");
    ...
    public void setImageError(){
	 ...
	 public class DoRead extends AsyncTask<String, Void, MjpegInputStream> {
	        ...
	        protected void onPostExecute(MjpegInputStream result) {
	            ...
	            mv.setDisplayMode(MjpegView.SIZE_down);
	            mv.showFps(true);
	    ...
	    public class DoRead1 extends AsyncTask<String, Void, MjpegInputStream> {
	        ...
	        protected void onPostExecute(MjpegInputStream result) {
	            ...
	            mv1.setDisplayMode(MjpegView.SIZE_up);
	            mv1.showFps(true);
