...
public class SettingsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null){
        	...
        	Gyroscope_Enable = extras.getBoolean("Gyroscope_Enable",Gyroscope_Enable);
        ...
        settings_done.setOnClickListener(
        		new View.OnClickListener(){
        			public void onClick(View view){     
        				...
        				intent.putExtra("LCamera_Enable", LCamera_Enable);
        				intent.putExtra("RCamera_Enable", RCamera_Enable);
        				intent.putExtra("Gyroscope_Enable", Gyroscope_Enable);
